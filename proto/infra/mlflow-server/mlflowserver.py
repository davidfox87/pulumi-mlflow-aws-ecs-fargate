...
class MLFlowServer(ComponentResource):
    ...
    def __init__(
        self, name: str, args: MLFlowServerArgs, opts: ResourceOptions = None
    ):

        super().__init__("MLFlow-server", name, {}, opts)
        ...
        app_exec_role = aws.iam.Role(
            ...
            inline_policies=[aws.iam.RoleInlinePolicyArgs(name='s3-env-access',
